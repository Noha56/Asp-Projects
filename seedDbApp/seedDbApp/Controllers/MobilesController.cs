...
namespace seedDbApp.Controllers
{
    public class MobilesController : Controller
    {
        private readonly seedDbAppContext _context;

        public MobilesController(seedDbAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MobileId,Model,Price")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MobileId,Model,Price")] Mobile mobile)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'seedDbAppContext.Mobile'  is null.");
            }
            var mobile = await _context.Mobile.FindAsync(id);
            if (mobile != null)
            {
